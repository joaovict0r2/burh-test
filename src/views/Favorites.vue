<template>
  <div id="main">
    <div>
      <button
        id="button-back"
        class="btn bg-white rounded-full absolute text-black  py-2 px-3"
      >
        <router-link to="/">
          <span class="pr-1"><i class="fas fa-arrow-left"></i></span>
        </router-link>
      </button>
      <div
        id="header"
    ...
    <div class="app-content">
      <div class="cards-content flex flex-wrap bg-gray-200 -mt-10 film-content">
        <ul
          class="ul-card"
          v-for="(film, index) in $store.state.favFilms" :key="index"
        >
          <div
            class="sm:w-full
              md:w-1/3
